...
function Resetpassword() {
  ...
  const changeHandler = (e) => (setInputpending(false), setInput(true), setEmail(e.target.value));

  const resetpassword = () => {
    if (!email) return setInput(false), setInputpending(false), toast.error('Data cannot be empty');
    axios
